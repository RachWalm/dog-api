...
class DogVaccineSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'dog_id', 'overdue',
            'vaccine_canine_parvovirus', 'vaccine_canine_hepatitis',
            'vaccine_distemper', 'vaccine_leptospirosis',
            'vaccine_kennelcough', 'vaccine_rabies',
            'vaccine_puppy_first', 'vaccine_puppy_second',
